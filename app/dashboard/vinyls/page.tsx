...
const searchParams = useSearchParams();
  ...
  const [loadingVinyl, setLoadingVinyl] = useState<boolean>(true);
  const [errorVinyl, setErrorVinyl] = useState<PostgrestError | null>(null);
  ...
  const { tracks, loading: loadingTracks, error: errorTracks } = useTracks(parsedVinylId);
        ...
        <div>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-2/3 lg:pl-10">
              ...
              <p className="text-gray-500 text-sm mb-4">Number of Tracks: {tracks.length}</p>
            </div>
          </div>
          {/* Tracks listing */}
          <div className='mt-6'>
